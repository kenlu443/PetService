...
public class MainActivity_Food3_3 extends AppCompatActivity {
    TextView txtmsg;
    Intent intent;
    Bundle get_bag;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food3_3);
        ...
        btnback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(MainActivity_Food3_3.this, MainActivity_Food.class);
