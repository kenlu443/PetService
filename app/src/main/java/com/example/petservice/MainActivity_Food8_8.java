...
public class MainActivity_Food8_8 extends AppCompatActivity {
    TextView txtmsg;
    Intent intent;
    Bundle get_bag;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food8_8);
        ...
        btnback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(MainActivity_Food8_8.this, MainActivity_Food.class);
