...
public class MainActivity_Food7_7 extends AppCompatActivity {
    TextView txtmsg;
    Intent intent;
    Bundle get_bag;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food7_7);
        ...
        btnback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(MainActivity_Food7_7.this, MainActivity_Food.class);
