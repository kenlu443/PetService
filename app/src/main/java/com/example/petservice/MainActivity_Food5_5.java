...
public class MainActivity_Food5_5 extends AppCompatActivity {
    TextView txtmsg;
    Intent intent;
    Bundle get_bag;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food5_5);
        ...
        btnback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(MainActivity_Food5_5.this, MainActivity_Food.class);
