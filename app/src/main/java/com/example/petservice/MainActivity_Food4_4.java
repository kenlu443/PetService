...
public class MainActivity_Food4_4 extends AppCompatActivity {
    TextView txtmsg;
    Intent intent;
    Bundle get_bag;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food4_4);
        ...
        btnback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(MainActivity_Food4_4.this, MainActivity_Food.class);
